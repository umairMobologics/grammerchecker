...
import 'package:grammar_checker_app_updated/Controllers/globalVariablrController.dart';
import 'package:grammar_checker_app_updated/View/Screens/Features/AskAi.dart';
import 'package:grammar_checker_app_updated/View/Screens/Features/Corrector.dart';
import 'package:grammar_checker_app_updated/View/Screens/Features/ParaphraseScreen.dart';
import 'package:grammar_checker_app_updated/View/Screens/Features/Translator.dart';
...
import '../Grammar_AI_Tutor/TutorDashBoardList.dart';

RxInt page = 2.obs;

class BottomNavBarScreen extends StatefulWidget {
  final int? indexat;
  const BottomNavBarScreen({super.key, this.indexat});
...
class _BottomNavBarScreenState extends State<BottomNavBarScreen> {
  ...
  void initState() {
    ...
    if (widget.indexat != null) {
      page.value = (widget.indexat!);
    }
  }
