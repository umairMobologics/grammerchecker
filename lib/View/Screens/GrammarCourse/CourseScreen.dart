...
import 'package:grammar_checker_app_updated/View/Screens/GrammarCourse/StartGrammarCourse.dart';
import 'package:grammar_checker_app_updated/View/Widgets/header_screends.dart';
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          // ElevatedButton(
          //     onPressed: () {
          //       FirebaseCourseServices.printLevelData("level7");
          //     },
          //     child: Text("fetch level")),
          Expanded(
            child: Bounce(
