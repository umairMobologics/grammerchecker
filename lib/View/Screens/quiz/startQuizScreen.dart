...
import 'package:grammar_checker_app_updated/core/databaseHelper/quizStatus.dart';
...
import 'package:grammar_checker_app_updated/core/utils/theme.dart';
        ...
        Padding(
          ...
          child: InkWell(
            onTap: () async {
              ...
              if (ispremium() && InterstitialAdClass.interstitialAd != null) {
