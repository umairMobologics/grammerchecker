...
import 'package:grammer_checker_app/View/Screens/GrammarCourse/CourseScreen.dart';
import 'package:grammer_checker_app/View/Screens/RewardCenter/RewardHomePage.dart';
...
class _HomepageState extends State<Homepage> {
  ...
  void checkNotification() async {
    ...
    if (permissionGranted) {
      ...
      AwesomeNotificationServices.scheduleDailyNotifications();
    } else {
