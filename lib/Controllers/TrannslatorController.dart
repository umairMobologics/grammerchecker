...
Map<String, String> languageCodes = {
 ...
 Future<String> translateText(BuildContext context, String sourceLang, String targetLang) async {
  log(targetLang);
  isresultLoaded.value = false;
  ...
  try {
    final translation = await translator.translate(
      controller.value.text, // Assuming controller.value.text holds the text to be translated
      to: targetLang,
    );
